...
function InventoryPage() {
    ...
    // =========================
    const fetchProductsAndWarehouses =
        async () => {
            try {
                const token =
                ...
                console.error(
                    "Fetch Products/Warehouses Error:",
                    error
                );
            }
        };
        ...
        <div className="min-h-screen bg-[#03040A] text-white relative overflow-hidden flex">
            ...
            <div className="flex-1 p-6 md:p-10 relative z-10 overflow-y-auto h-screen">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mt-10">
                    ...
                    <div className="rounded-[36px] border border-white/10 bg-white/[0.04] backdrop-blur-3xl p-8 shadow-[0_0_80px_rgba(139,92,246,0.08)]">
                ...
                <div className="flex items-center justify-between mt-12">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 mt-2">
                            Monitor all physical products stored across warehouses.
                        </p>
                    </div>
                        ...
                        <div className="p-10 border-b border-white/10">
                            ...
                            <p className="text-slate-400 mt-2">
                                {isEditing
                                    ...
                                    : "Allocate product instances to warehouse node."}
                            </p>
